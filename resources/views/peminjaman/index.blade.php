...
<head>
    ...
    <title>Transaksi Peminjaman | SIMALAB ITDA</title>
...
<body class="bg-slate-50 font-sans text-slate-900 antialiased flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col z-20">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="#" class="flex items-center px-3 py-2 text-sm font-semibold bg-blue-50 text-blue-700 border-r-4 border-blue-700 rounded-l-md">
                <i data-lucide="arrow-right-left" class="w-4 h-4 mr-3 text-blue-700"></i> Transaksi
            </a>
        </nav>
    ...
    <main class="flex-1 overflow-y-auto">
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8">
            <h1 class="text-lg font-semibold text-slate-800">Manajemen Transaksi</h1>
        </header>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-slate-600">
                        <thead class="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-200">
                            <tr>
                                <th scope="col" class="px-6 py-4 font-semibold tracking-wider">Nama Mahasiswa</th>
                                <th scope="col" class="px-6 py-4 font-semibold tracking-wider">Barang Dipinjam</th>
                                <th scope="col" class="px-6 py-4 font-semibold tracking-wider">Tanggal Pinjam</th>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right space-x-3">
                                    <a href="{{ route('peminjaman.edit', $pinjam->id) }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition-colors">
                                        <i data-lucide="edit-3" class="w-4 h-4 mr-1"></i> Edit Status
                                    </a>
